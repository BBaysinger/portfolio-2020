...
Really, just a simple SPA with dynamic routing, built to later integrate with headless CMS. It runs off of static JSON containing flags to activate different features of various portfolio pieces.
